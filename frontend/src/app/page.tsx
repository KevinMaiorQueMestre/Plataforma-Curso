    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-7xl relative">
      <header className="flex justify-between items-end mb-6">
        <div>
          ...
          <p className="text-slate-500 mt-1 font-medium">Registre diariamente seu volume de questões para nutrir as estatísticas e o calendário.</p>
        </div>
        <button 
          onClick={() => setModalOpen(true)}
          className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-5 py-3 rounded-xl flex items-center gap-2 transition-colors shadow-md shadow-indigo-200"
        >
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b-2 border-slate-50">
                    ...
                    <th className="pb-4 pt-2 px-4 text-xs font-bold text-slate-400 uppercase tracking-wider">Disciplina / Assunto</th>
                    <th className="pb-4 pt-2 px-4 text-xs font-bold text-slate-400 uppercase tracking-wider">Volume</th>
                    <th className="pb-4 pt-2 px-4 text-xs font-bold text-slate-400 uppercase tracking-wider">Performance</th>
                  </tr>
                </thead>
          ...
          <div className="bg-white rounded-3xl w-full max-w-sm shadow-2xl relative animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[85vh] overflow-y-auto hidden-scrollbar">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-wide">Horas</label>
                  <input 
                    type="number" 
                    step="0.1"
                    min="0.1"
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-wide">Qtd. Feitas</label>
                  <input 
                    type="number" 
                    min="1"
                    placeholder="Ex: 30"
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-2 uppercase tracking-wide">Acertos</label>
                  <input 
                    type="number" 
                    min="0"
                    placeholder="Ex: 25"
